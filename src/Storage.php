<?php
namespace yiioverflow\filekit;

use League\Flysystem\FilesystemInterface;
use yiioverflow\filekit\events\StorageEvent;
...
class Storage extends Component
{
    ...
    {
        /* @var \yiioverflow\filekit\events\StorageEvent $event */
     ...
     * @param $filesystem
     */
    public function setBaseUrl($basUrl)
    {
        $this->baseUrl = $basUrl;
    }     
}
